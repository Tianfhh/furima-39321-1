class Item < ApplicationRecord
  ...
  validates :condition_id, presence: true, numericality: { greater_than: 1 }
  validates :shipping_fee_id, presence: true, numericality: { greater_than: 1 }
  validates :prefecture_id, presence: true  , numericality: { greater_than: 1 }
  validates :shipping_date_id, presence: true, numericality: { greater_than: 1 }
